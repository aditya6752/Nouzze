...
object Constants {
    ...
    val MAP_AGE_PROFESSION_TIME = mapOf<String, Map<String, Int>>(
    ...
    val MAP_EVERYTHING = mapOf<String, Map<String, Map<String, Pair<Int, Int>>>>(
        ...
        ,
        "23-35" to mapOf("Engineering" to mapOf("Influencers" to Pair(70, -20),
            ...
            "Banking" to mapOf("Influencers" to Pair(70, -20),
                "Messaging" to Pair(70, -10), "Productivity social media app" to Pair(100, 40),
                "Free Entertainment" to Pair(70, -10), "Paid Entertainment" to Pair(70, -20),
                "Shopping" to Pair(70, -30), "Grocery and Food" to Pair(70, -30), "Travel" to Pair(80, 20)),
            "Finance" to mapOf("Influencers" to Pair(70, -20),
                "Messaging" to Pair(70, -10), "Productivity social media app" to Pair(100, 40),
                "Free Entertainment" to Pair(70, -10), "Paid Entertainment" to Pair(70, -20),
                "Shopping" to Pair(70, -30), "Grocery and Food" to Pair(70, -30), "Travel" to Pair(80, 20)),
            "Doctors" to mapOf("Influencers" to Pair(70, -20),
                "Messaging" to Pair(70, -10), "Productivity social media app" to Pair(100, 40),
                "Free Entertainment" to Pair(70, -10), "Paid Entertainment" to Pair(70, -20),
                "Shopping" to Pair(70, -30), "Grocery and Food" to Pair(70, -30), "Travel" to Pair(80, 20)),

            "Teaching and Education" to mapOf("Influencers" to Pair(80, -10),
                "Messaging" to Pair(70, -10), "Productivity social media app" to Pair(100, 40),
                "Free Entertainment" to Pair(80, -10), "Paid Entertainment" to Pair(80, -20),
                "Shopping" to Pair(90, -20), "Grocery and Food" to Pair(90, -20), "Travel" to Pair(80, 25)),

            "Business" to mapOf("Influencers" to Pair(70, 30),
                "Messaging" to Pair(100, 20), "Productivity social media app" to Pair(100, 40),
            ...
            "Media and Entertainment" to mapOf("Influencers" to Pair(100, 40),
            ...
            "Sales and Marketing" to mapOf("Influencers" to Pair(90, 30),
            ...
            "Social Work" to mapOf("Influencers" to Pair(100, 50),
            ...
            "Sports and Athletics" to mapOf("Influencers" to Pair(60, -10),
            ...
            "Driver" to mapOf("Influencers" to Pair(60, -20),
            ...
            "Student" to mapOf("Influencers" to Pair(80, -10),
            ...
            "House Maker" to mapOf("Influencers" to Pair(89, -10),
            ...
            "Others" to mapOf("Influencers" to Pair(70, -15),
        ...
        ,
        "36-60" to mapOf("Engineering" to mapOf("Influencers" to Pair(60, -30),
                "Messaging" to Pair(70, -30), "Productivity social media app" to Pair(80, 0),
                "Free Entertainment" to Pair(80, -10), "Paid Entertainment" to Pair(80, -20),
                "Shopping" to Pair(70, -20), "Grocery and Food" to Pair(80, -20), "Travel" to Pair(90, -10)),
            "Banking" to mapOf("Influencers" to Pair(60, -30),
            ...
            "Business" to mapOf("Influencers" to Pair(70, 10),
                "Messaging" to Pair(80, 10), "Productivity social media app" to Pair(100, 10),
                "Free Entertainment" to Pair(90, 10), "Paid Entertainment" to Pair(90, 10),
                "Shopping" to Pair(80, 10), "Grocery and Food" to Pair(90, 10), "Travel" to Pair(90, 10)),
            ...
            "Sales and Marketing" to mapOf("Influencers" to Pair(100, -10),
                "Messaging" to Pair(100, 0), "Productivity social media app" to Pair(90, -10),
                "Free Entertainment" to Pair(70, -20), "Paid Entertainment" to Pair(70, -20),
                "Shopping" to Pair(80, -10), "Grocery and Food" to Pair(90, -20), "Travel" to Pair(90, -10)),
        ...
        ,
        "60+" to mapOf("Engineering" to mapOf("Influencers" to Pair(80, -30),
                "Messaging" to Pair(90, -20), "Productivity social media app" to Pair(100, 0),
                "Free Entertainment" to Pair(70, -20), "Paid Entertainment" to Pair(60, -30),
                "Shopping" to Pair(80, -10), "Grocery and Food" to Pair(80, -10), "Travel" to Pair(70, 0)),
            "Banking" to mapOf("Influencers" to Pair(80, -30),
